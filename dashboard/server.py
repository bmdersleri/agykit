...
def get_current_mtime_state():
    ...
    brain_dir = os.environ.get("AGYKIT_DASH_BRAIN") or os.path.expanduser("~/.gemini/antigravity-cli/brain")
...
def main():
    ...
    parser.add_argument("--port", type=int, default=8787, help="Port to bind to (default: 8787)")
